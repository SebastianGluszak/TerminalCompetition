...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def on_game_start(self, config):
        ...
        # self.friendly_edges = self.helper_map.get_edge_locations(self.helper_map.BOTTOM_LEFT) + self.helper_map.get_edge_locations(self.helper_map.BOTTOM_RIGHT)
    ...
    def demolisher_charge(self,game_state):
        game_state.attempt_spawn(DEMOLISHER,self.demolisher_assembly_point,num=game_state.number_affordable(DEMOLISHER))
